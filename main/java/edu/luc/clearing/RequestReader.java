...
public class RequestReader {
	...
	private static Double processFraction(String fraction) {
		...
		if (fractionParts.length == 1) {
			/*
			 * must be 4 slashes. String escapes 2, then regex uses one as an
			 * escape. see Chris Smith @
			 * http://www.velocityreviews.com/forums/t138967
			 * -help-using-string-split.html
			 */
